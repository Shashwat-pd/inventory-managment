...
import { z } from 'zod';
import { useDeleteProductMutation, useGetProductDetailQuery, useGetProductsQuery, usePostProductMutation, usePutProductMutation } from '@/redux/api/ProductApi';
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            <div className="flex justify-between items-start mb-4">
              <h2 className="text-2xl font-bold">{productDetailData.name}</h2>
              <button
            ...
            <div className="mb-4">
              <p className="text-3xl font-bold text-green-600 mb-2">${productDetailData.price}</p>
          ...
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <form onSubmit={handleAddSubmit(onAddProduct)} className="space-y-4">
              ...
              <div>
                ...
                />
                {addErrors.price && (
                  <p className="text-red-500 text-sm mt-1">{addErrors.price.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {addErrors.department_id && (
                  <p className="text-red-500 text-sm mt-1">{addErrors.department_id.message}</p>
                )}
              </div>
          ...
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <form onSubmit={handleEditSubmit(onEditProduct)} className="space-y-4">
              ...
              <div>
                ...
                />
                {editErrors.price && (
                  <p className="text-red-500 text-sm mt-1">{editErrors.price.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {editErrors.department_id && (
                  <p className="text-red-500 text-sm mt-1">{editErrors.department_id.message}</p>
                )}
              </div>
